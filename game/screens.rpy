...
init python:
    ...
    def translate():
        if _preferences.language == "spanish":
            ...
            layout.ARE_YOU_SURE = "Czy jesteś pewien?"
            layout.DELETE_SAVE = "Czy na pewno chcesz usunąć ten zapis?"
            layout.OVERWRITE_SAVE = "Czy na pewno chcesz nadpisać ten zapis?"
            layout.LOADING = "Wczytywanie spowoduje utratę niezapisanego progresu.\nCzy na pewno chcesz to zrobić?"
            layout.QUIT = "Czy na pewno chcesz wyjść?"
            layout.MAIN_MENU = "Czy na pewno chcesz wrócić do menu głównego?\nSpowoduje to utratę niezapisanego progresu."
            layout.SLOW_SKIP = "Are you sure you want to begin skipping?"
            layout.FAST_SKIP_UNSEEN = "Are you sure you want to skip to the next choice?"
            layout.FAST_SKIP_SEEN = "Are you sure you want to skip to unseen dialogue or the next choice?"
...
screen main_menu:
    ...
    imagemap:
        if _preferences.language == "spanish":
            ...
            auto "images/gui/title_menu/mainmenu_pl_%s.jpg"
        elif _preferences.language == "chinese":
...
screen game_menu_selector:
    ...
    imagemap:
        ...
        if _preferences.language == "spanish":
            ...
            auto get_image("gui/ingame_menu/"+timeofday+"/ingame_menu_pl_%s.png") xalign 0.5 yalign 0.5
        elif _preferences.language == "chinese":
...
screen collector_ach:
    ...
    python:
        if _preferences.language == None:
            ...
            ach = "images/misc/ach/collector_pl.png"
        elif _preferences.language == "italian":
...
screen language_menu:
    ...
    frame background Frame(get_image("gui/choice/day/choice_box.png"),50,50) xfill True yalign 0.5 left_padding 75 right_padding 75 bottom_padding 50 top_padding 50:
        ...
        grid 1 7 xfill True:
            ...
            hbox xalign 0.5:
                if _preferences.language == "polish":
                    add get_image("gui/settings/leaf.png") ypos 0.12
                else:
                    null width 22
                textbutton translation_new["Polish"] style "log_button" text_style "sprite_menu" action (SetField(config, "window_title", "Wieczne Lato"), SetField(persistent, "show_hentai_ach", False), Language("polish"), Function(reload_names), Function(stop_music), Function(renpy.utter_restart))
            ...
            side "c b r":
                ...
                viewport id "filters":
                    ...
                    for i,(item) in enumerate(persistent.filters):
                        textbutton translation_new["filters"+unicode(i)] style "log_button" text_style "settings_text" action (Function(apply_filter, i), ShowMenu('filters'))
                        if item["is_active"]:
                            add get_image("gui/settings/leaf.png") ypos 0.12
                        else:
                            null
            ...
            if action and caption:
                ...
                button background None:
                    ...
                    if persistent.licensed:
                        if caption in persistent.choices and caption != "Налево" and caption != "Направо" and caption != "Go left" and caption != "Go right" and caption != "Idź w lewo" and caption != "Idź w prawo" and caption != "Ir a la izquierda" and caption != "Ir a la derecha":
