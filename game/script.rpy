...
label splashscreen_2:
    ...
    if not persistent.lan_chosen:
        ...
        python:
            ...
            ui.imagebutton("images/misc/english_ground.png", "images/misc/english_hover.png", clicked = ui.returns("english"), align = (0.5, 0.32))
            
            ui.imagebutton("images/misc/polish_ground.png", "images/misc/polish_hover.png", clicked = ui.returns("polish"), align = (0.5, 0.44))

            ui.imagebutton("images/misc/spanish_ground.png", "images/misc/spanish_hover.png", clicked = ui.returns("spanish"), align = (0.5, 0.56))

            ui.imagebutton("images/misc/italian_ground.png", "images/misc/italian_hover.png", clicked = ui.returns("italian"), align = (0.5, 0.68))
            ...
            if result == "None":
                ...
                renpy.show("pl_ground", [lang_pl_ground])
                ...
                _preferences.language = "polish"
                renpy.show("ru_ground", [lang_ru_ground])
                renpy.show("en_ground", [lang_en_ground])
                renpy.show("pl_hover", [lang_pl_hover])
                renpy.show("es_ground", [lang_es_ground])
                renpy.show("it_ground", [lang_it_ground])
                renpy.show("ch_ground", [lang_ch_ground])
            elif result == "spanish":                                   
